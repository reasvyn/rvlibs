...
- [Hooks and Setup](../patterns/hooks-and-setup.md) — setup/teardown with lifecycle hooks
- [Parametrized Tests](../patterns/parametrized-tests.md) — running the same logic with multiple inputs
