...
- [Writing Tests](../basics/writing-tests.md) — test structure and patterns
- [Property-Based Testing](../patterns/property-based-testing.md) (recommended) — testing invariants
...
- [Architecture Tests](../advanced/architecture-tests.md) — enforcing module structure
