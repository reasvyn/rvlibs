...
- [Numeric Types](../foundations/numeric-types.md) — `Num<T>`, basic operations
...
- [Linear Algebra](../linear-algebra/linear-algebra.md) — vectors, matrices, and tensors
- [Calculus](../calculus/calculus.md) — derivatives and integrals
