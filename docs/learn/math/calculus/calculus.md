...
- [Numeric Types](../foundations/numeric-types.md) — `Num<T>`, `Numeric` trait
...
- [Geometry](../geometry/geometry.md) — constants, 2D and 3D shape formulas
- [Numeric Types](../foundations/numeric-types.md) — `Num<T>`, `Percentage`
