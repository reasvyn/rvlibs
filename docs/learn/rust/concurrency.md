...
- [Traits](traits.md) — understanding trait bounds
- [Collections](collections.md) — `Vec`, `HashMap`
...
- [Modules and Packages](modules-and-packages.md) — organizing Rust projects
